...
public record FinalTransformation(double a, double b, double c, double d, double e, double f) {
    public static FinalTransformation randomFinalTransformation() {
        while (true) {
            ...
            if (isCoefValid(a, b, c, d, e, f)) {
                return new FinalTransformation(a, b, c, d, e, f);
            }
        }
    }
